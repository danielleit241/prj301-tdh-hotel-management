    ...
    <body>       
        ...
        <div class="container mt-5">
            ...
            <form action="./manageBookings">
                <input style="width: 80%" type="text" name="search" value="${param.search}">
                ...
                <tbody>
                    ...
                    <c:forEach var="booking" items="${roomBookings}">
                        <tr>
                            ...
                            <td><c:out value="${booking.getTypeRoomName()}"/></td>
                           ...
                           <td>
                                <c:choose>
                                    <c:when test="${booking.getStatus() == 'đang đặt (chưa thanh toán)'}">
                                        <form action="manageBookings" onsubmit="return confirmDelete();">
                                            <input type="hidden" name="bookingID" value="${booking.getBookingID()}">
                                    ...
                                    <c:otherwise>
                                        ...
                                        <span style="color: grey; font-style: italic;">Không thể xóa, phòng đã xác nhận</span>
                                    </c:otherwise>
                                </c:choose>
                            </td>
                        </tr>
