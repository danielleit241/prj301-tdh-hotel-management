...
public class BookingDTO {
    ...
    public BookingDTO(String bookingID, int roomID, int typeRoomID, String typeRoomName, String username, String phone, Date checkInDate, Date checkOutDate, int totalPrice, String status) {
        this.bookingID = bookingID;
        this.roomID = roomID;
        this.typeRoomID = typeRoomID;
